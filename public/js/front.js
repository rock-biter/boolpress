  ...
  methods: {
    send: function send() {
      ...
      axios.post('/api/leads', {
        ...
        _this.name = _this.message = _this.email = '';
        _this.errors = {};
        _this.success = true;
      })["catch"](function (err) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    matchLayout: function matchLayout() {
      var layout = this.$route.meta.layout;
      switch (layout) {
        case 'sidebar':
          this.layout = function () {
            return __webpack_require__.e(/*! import() */ 0).then(__webpack_require__.bind(null, /*! ../layouts/Sidebar.vue */ "./resources/js/layouts/Sidebar.vue"));
          };
          break;
        default:
          this.layout = function () {
            return __webpack_require__.e(/*! import() */ 1).then(__webpack_require__.bind(null, /*! ../layouts/Layout.vue */ "./resources/js/layouts/Layout.vue"));
          };
      }
    }
  },
...
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c("div", {
    staticClass: "divide-y divide-y-stone-200 shadow-lg rounded-lg flex flex-col"
  }, [_c("header", {
    staticClass: "bg-stone-200 aspect-video"
  }, [_vm._t("header")], 2), _vm._v(" "), _c("div", {
    staticClass: "py-3 px-6 grow"
...
var render = function render() {
  ...
  return _c("div", [_vm.success ? _c("div", {
    staticClass: "text-lg p-2 bg-green-200 border border-green-300 rounded-lg"
    ...
    "class": [_vm.errors.name ? "border-red-400" : "border-stone-200", "rounded-lg px-2 py-2 border  w-full"],
    attrs: {
      type: "text",
      name: "name",
      placeholder: "Nome"
    ...
    staticClass: "flex gap-3 text-red-400"
    ...
    domProps: {
      value: _vm.sending ? "waiting" : "invia"
    }
  })])])]);
};
var staticRenderFns = [];
...
var render = function render() {
  ...
  return _c("Card", {
    ...
    scopedSlots: _vm._u([{
      key: "header",
      fn: function fn() {
        return [_vm.post.cover ? _c("img", {
          staticClass: "h-full w-full object-cover object-center",
          attrs: {
...
var render = function render() {
  ...
  return _c("div", [_c("section", [_c("div", {
    staticClass: "container"
  }, [_c("h1", [_vm._v("Pagina di dettaglio del post")]), _vm._v(" "), _c("p", [_vm._v(_vm._s(_vm.slug))])])])]);
};
var staticRenderFns = [];
render._withStripped = true;
...
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _vm.layout ? _c(_vm.layout, {
    tag: "component"
...
__webpack_require__(/*! /Users/gianlucalomarco/Dev/mamp/boolean70/boolpress/resources/js/front.js */"./resources/js/front.js");
module.exports = __webpack_require__(/*! /Users/gianlucalomarco/Dev/mamp/boolean70/boolpress/resources/sass/back.scss */"./resources/sass/back.scss");
